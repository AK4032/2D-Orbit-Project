...
public class Frame extends JPanel{
    ...
    public void paintComponent(Graphics g){
        ...
        g2d.setRenderingHints(antiA);

        g2d.setColor(Color.BLACK);
        g2d.fillRect(0,0,1920,1080);

        
        for (Object i : Program.objectList){
            this.drawObject(g2d,i);
        }
    ...
    private void drawObject(Graphics2D g2d, Object i){
        if (i == Program.objectList.get(0)){
            g2d.setColor(new Color(192,162,77));
            int[] coords = Program.convertCoords(i.pos);
            int r = (int)(i.radius*Program.pixelsPerMeter);
            g2d.fillOval(coords[0]-r, coords[1]-r, 2*r,2*r);
        }
            ...
            int[] coords = Program.convertCoords(i.pos);
            int r = (int)(i.radius*Program.pixelsPerMeter);
            g2d.drawOval(coords[0]-r, coords[1]-r, 2*r,2*r);
        }
    }
    private void drawArrow(Graphics2D g2d, Arrow i){
        if (i != Program.objectList.get(0).velocityArrow && i.visible){
            g2d.setColor(new Color(255,100,100));
            g2d.drawLine(i.pos0[0],i.pos0[1], i.pos1[0],i.pos1[1]);
            this.drawDot(g2d, i.pos1[0],i.pos1[1], 5);
        }
    }
}