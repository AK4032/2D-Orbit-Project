    ...
    public void createLine(){
        if (this.type != "n"){
            ...
            for (int i = 0; i<numOfPoints; i++){
                ...
                if(this.type == "x"){
                    this.lineCoords.add(this.convertCoords(new double[]{e, this.method1.run1(e,false)}));
                }
                else if(this.type == "y"){
                    this.lineCoords.add(this.convertCoords(new double[]{this.method1.run1(e,false), e}));
                }
                else if(this.type == "t"){
                    this.lineCoords.add(this.convertCoords(this.method2.run2(e)));
                }
                else if(this.type == "p"){
                    double r = this.method1.run1(e,false);
