...
public class Object extends ScreenComponent{
    ...
    public void updatePos(){
        ...
        Function drd0 = Program.derivitive(this.graph.method1);
        double d0 = arcLength/(Math.sqrt(this.graph.method1.run1(thetaPos)*this.graph.method1.run1(thetaPos) + Math.pow(drd0.run1(thetaPos), 2)));
        d0 *= this.orientation;

        double new0 = d0 + thetaPos;
        double newR = this.graph.method1.run1(new0);
    ...
    public void updateVelocity(){
        ...
        //System.out.println(this.potentialEnergy());

        double r = this.graph.method1.run1(this.currentAngle);
        double drd0 = Program.derivitive(this.graph.method1).run1(this.currentAngle);
